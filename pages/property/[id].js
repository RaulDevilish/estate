    ...
    <Box maxWidth='1000px' margin='auto' p='4'>
        ...
        <Box w='full' p='6'>
            ...
            <Flex flexWrap='wrap' textTransform='uppercase' justifyContent='space-between'>
                <Flex justifyContent='space-between' w='400px' borderBottom='2px' borderColor='gray.200' p='3'>
                    <Text>
                        Type:
                    </Text>
                ...
                {furnishingStatus && (
                    <Flex justifyContent='space-between' w='full' marginTop='30px' borderBottom='2px' borderColor='gray.200' p='3'>
                        <Text>
                            Furnishing Status:
                        </Text>
            ...
            <Box>
                {amenities.length && <Text fontSize='xl' fontWeight='medium' marginTop='5' marginBottom='2'>Amenities: </Text>}
                <Flex flexWrap='wrap'>
                    {amenities.map((item) => (
